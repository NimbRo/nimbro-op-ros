...
namespace behaviourexercise
{
	...
	protected:
		...
		gait::GaitCommand m_lastGaitCmd;
	...
	public:
		...
		// Gait functions
		void sendGaitCommand(gait::GaitCommand cmd);
	...
	protected:
		...
		double adjustCmdForObstacle(gait::GaitCommand& cmd, Eigen::Vector2d ballVec, Eigen::Vector2d obstVec);
	};
