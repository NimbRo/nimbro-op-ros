...
void LocalizationPF::handleCompass(const robotcontrol::CompassHeadingConstPtr& compass)
{
...
// 	bool debugPublished = false;
	...
	if(m_compassHeading && (ros::Time::now() - m_compassHeading->stamp) < ros::Duration(2.0))
	{
