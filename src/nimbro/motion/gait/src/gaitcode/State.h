...
// #include "StepController/LimpState.h"
#include "Command.h"
...
// 		LimpState comState; // COM state as estimated by the KB model.
// 		LimpState trunkAngleState; // Torso angle state made from a pendulum model for the fused angle.
// 		LimpState soleAngleState;
